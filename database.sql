...
CREATE TABLE IF NOT EXISTS `mydb`.`score_activity` (
  ...
  INDEX `fk_score_likeactivity1_idx` (`likeactivity_likeactivity_id` ASC) VISIBLE,
  INDEX `fk_score_offers1_idx` (`offers_offer_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`shops_has_offers` (
  ...
  INDEX `fk_offers_has_shops_shops1_idx` (`shops_shop_id` ASC) VISIBLE,
  INDEX `fk_offers_has_shops_offers1_idx` (`offers_offer_id` ASC) VISIBLE,
